...
prompt_consultor_playa=ChatPromptTemplate.from_messages([
    ("system","Preséntate como Sra. Playa. Eres una especialista de viajes con destinos de playa."),
    ("human","{query}")
])

prompt_consultor_montana=ChatPromptTemplate.from_messages([
    ("system","Preséntate como Sr. Montana. Eres una especialista de viajes a montañas y actividades de aventura."),
    ("human","{query}")
])
